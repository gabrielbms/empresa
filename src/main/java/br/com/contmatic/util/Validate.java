...
public class Validate {
	...
	private static boolean realizaCalculoDoDigitoVerificadorDoCpf(String CPF) {
		...
		try {
			dig10 = calculoDoPrimeiroDigitoDoCpf(CPF);
			dig11 = calculoDoSegundoDigitoDoCpf(CPF);
	...
	private static char calculoDoPrimeiroDigitoDoCpf(String CPF) {
		char dig10;
		int soma;
		int i;
		int resultado;
	...
	private static char calculoDoSegundoDigitoDoCpf(String CPF) {
		char dig11;
		int soma;
		int i;
		int resultado;
	...
	private static boolean realizaCalculoDoDigitoVerificadorDoCnpj(String CNPJ) {
		...
		try {
			dig13 = calculoDoPrimeiroDigitoDoCnpj(CNPJ);
			dig14 = calculoDoSegundoDigitoDoCnpj(CNPJ);
	...
	private static char calculoDoPrimeiroDigitoDoCnpj(String CNPJ) {
		char dig13;
		int soma;
		int i;
		int resultado;
	...
	private static char calculoDoSegundoDigitoDoCnpj(String CNPJ) {
		char dig14;
		int soma;
		int i;
		int resultado;
